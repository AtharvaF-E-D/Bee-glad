...
import { createSmartSolutions } from "@/lib/services/admin/smartSolution.service";
...
const CreateSolutionForm = ({ onSuccess }: Props) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // ================= CREATE SOLUTION =================
            const response = await createSmartSolutions(payload);
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={inputClass}
                            placeholder="e.g. Custom Web Apps, UI/UX Development"
                        />
                    </div>
